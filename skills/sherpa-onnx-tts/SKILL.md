...
1. Download the runtime for your OS (extracts into `~/.genesis/tools/sherpa-onnx-tts/runtime`)
2. Download a voice model (extracts into `~/.genesis/tools/sherpa-onnx-tts/models`)

Update `~/.bridgeia-chile/Genesis.json`:
