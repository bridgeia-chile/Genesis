...
import type { ReplyPayload, genesisConfig } from "genesis/plugin-sdk";
import { createReplyPrefixOptions } from "genesis/plugin-sdk";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as genesisConfig;
