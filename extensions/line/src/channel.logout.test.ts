import type { genesisConfig, PluginRuntime, ResolvedLineAccount } from "genesis/plugin-sdk";
...
function createRuntime(): { runtime: PluginRuntime; mocks: LineRuntimeMocks } {
  ...
  const resolveLineAccount = vi.fn(
    ({ cfg, accountId }: { cfg: genesisConfig; accountId?: string }) => {
...
async function runLogoutScenario(params: { cfg: genesisConfig; accountId: string }): Promise<{
