...
export function listMattermostAccountIds(cfg: genesisConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: genesisConfig): string {
...
export function listEnabledMattermostAccounts(cfg: genesisConfig): ResolvedMattermostAccount[] {
