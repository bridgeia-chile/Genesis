...
export function listGoogleChatAccountIds(cfg: genesisConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: genesisConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: genesisConfig): ResolvedGoogleChatAccount[] {
