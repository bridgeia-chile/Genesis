...
This directory contains the **BlueBubbles external channel plugin** for genesis.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `genesis/plugin-sdk` helpers.
