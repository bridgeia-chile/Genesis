...
import { resolveChannelMediaMaxBytes, type genesisConfig } from "genesis/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: genesisConfig; accountId?: string }): string[] {
