...
export function listZalouserAccountIds(cfg: genesisConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: genesisConfig): string {
...
function mergeZalouserAccountConfig(cfg: genesisConfig, accountId: string): ZalouserAccountConfig {
