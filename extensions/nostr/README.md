...
Nostr DM channel plugin for genesis using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to genesis. It enables your bot to:
...
# Configure genesis to use local relay
