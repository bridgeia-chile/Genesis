...
function resetChatStateForSessionSwitch(state: AppViewState, sessionKey: string) {
  ...
  (state as unknown as genesisApp).chatStreamStartedAt = null;
  state.chatRunId = null;
  (state as unknown as genesisApp).resetToolStream();
  (state as unknown as genesisApp).resetChatScroll();
  state.applySettings({
    ...state.settings,
    sessionKey,
  ...
  return html`
    <div class="chat-controls">
      ...
      <button
        ...
        @click=${async () => {
          const app = state as unknown as genesisApp;
