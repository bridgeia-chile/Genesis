...
describe("subtitleForTab", () => {
  ...
  it("returns descriptive subtitles", () => {
    ...
    expect(subtitleForTab("config")).toContain("genesis.json");
  });
});
...
describe("normalizeBasePath", () => {
  ...
  it("handles nested paths", () => {
    expect(normalizeBasePath("/apps/genesis")).toBe("/apps/genesis");
  });
});
...
describe("pathForTab", () => {
  ...
  it("prepends base path", () => {
    ...
    expect(pathForTab("sessions", "/apps/genesis")).toBe("/apps/genesis/sessions");
  });
});
...
describe("tabFromPath", () => {
  ...
  it("handles base paths", () => {
    ...
    expect(tabFromPath("/apps/genesis/sessions", "/apps/genesis")).toBe("sessions");
  });
...
describe("inferBasePathFromPathname", () => {
  ...
  it("infers base path from nested paths", () => {
    ...
    expect(inferBasePathFromPathname("/apps/genesis/sessions")).toBe("/apps/genesis");
  });
