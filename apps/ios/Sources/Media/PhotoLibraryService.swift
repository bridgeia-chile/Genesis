...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: genesisPhotosLatestParams) async throws -> genesisPhotosLatestPayload {
        ...
        var results: [genesisPhotoPayload] = []
        ...
        return genesisPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> genesisPhotoPayload
    {
