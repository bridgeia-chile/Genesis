...
enum WatchMessagingError: LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .watchAppNotInstalled:
            "WATCH_UNAVAILABLE: genesis watch companion app is not installed"
        }
    }
}

final class WatchMessagingService: NSObject, WatchMessagingServicing, @unchecked Sendable {
    private static let logger = Logger(subsystem: "ai.genesis", category: "watch.messaging")
        ...
        params: genesisWatchNotifyParams) async throws -> WatchNotificationSendResult
    {
        ...
        var payload: [String: Any] = [
            ...
            "title": params.title,
            "body": params.body,
            "priority": params.priority?.rawValue ?? genesisNotificationPriority.active.rawValue,
