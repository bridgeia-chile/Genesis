...
@MainActor
public struct genesisChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: genesisChatViewModel
    ...
    public init(
        viewModel: genesisChatViewModel,
    ...
    private var visibleMessages: [genesisChatMessage] {
        let base: [genesisChatMessage]
    ...
    private func mergeToolResults(in messages: [genesisChatMessage]) -> [genesisChatMessage] {
    ...
    private func isToolResultMessage(_ message: genesisChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: genesisChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: genesisChatMessage) -> String {
