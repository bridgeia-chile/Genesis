...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.genesis", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.genesis", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: genesisProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
