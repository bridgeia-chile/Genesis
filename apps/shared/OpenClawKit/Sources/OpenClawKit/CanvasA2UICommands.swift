...
public enum genesisCanvasA2UICommand: String, Codable, Sendable {
...
public struct genesisCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct genesisCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
