...
public enum genesisTalkCommand: String, Codable, Sendable {
...
public struct genesisTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct genesisTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
