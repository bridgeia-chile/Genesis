## genesis Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_genesis-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm genesis gateway --port 18789 --verbose
```
