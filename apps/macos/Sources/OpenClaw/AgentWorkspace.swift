...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.genesis", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return genesisConfigFile.defaultWorkspaceURL() }
