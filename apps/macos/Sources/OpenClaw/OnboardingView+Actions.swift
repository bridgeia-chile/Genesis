...
extension OnboardingView {
    ...
    func openSettings(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .genesisSelectSettingsTab, object: tab)
        }
    }
    ...
    func finish() {
        UserDefaults.standard.set(true, forKey: "genesis.onboardingSeen")
    ...
    func finishAnthropicOAuth() async {
        ...
        do {
            ...
            self.anthropicAuthStatus = "Connected. genesis can now use Claude."
        } catch {
