...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/genesis/genesis") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/genesis/genesis")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "genesisBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "genesisBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "genesisGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "genesisGitCommit") as? String) ??
            "unknown"
    }
