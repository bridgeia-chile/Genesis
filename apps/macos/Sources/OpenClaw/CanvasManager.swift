...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.genesis", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("genesis/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__genesis__/a2ui/").absoluteString + "?platform=macos"
    }
