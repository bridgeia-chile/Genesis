...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.genesis", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.genesis", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [genesisChatMessage] = messages.compactMap { item in
