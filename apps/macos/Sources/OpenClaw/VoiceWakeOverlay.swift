...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.genesis", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other genesis windows, but below the system’s pop-up menus.
