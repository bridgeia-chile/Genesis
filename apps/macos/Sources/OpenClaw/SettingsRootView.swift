...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .genesisSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? genesisPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? genesisPaths.stateDirURL.path
...
extension Notification.Name {
    static let genesisSelectSettingsTab = Notification.Name("genesisSelectSettingsTab")
}
