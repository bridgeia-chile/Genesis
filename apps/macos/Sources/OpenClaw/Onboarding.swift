...
enum UIStrings {
    static let welcomeTitle = "Welcome to genesis"
}
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: genesisOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: genesisChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g genesis@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: genesisChatViewModel(
