...
private let onboardingWizardLogger = Logger(subsystem: "ai.genesis", category: "onboarding.wizard")

// MARK: - Swift 6 AnyCodable Bridging Helpers

// Bridge between genesisProtocol.AnyCodable and the local module to avoid
// Swift 6 strict concurrency type conflicts.

private typealias ProtocolAnyCodable = genesisProtocol.AnyCodable
