...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.genesis", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        genesisPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        genesisPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
