...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.genesis", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".genesis/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.genesisCommand(
            subcommand: "gateway",
