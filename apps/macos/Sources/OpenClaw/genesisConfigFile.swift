...
enum genesisConfigFile {
    private static let logger = Logger(subsystem: "ai.genesis", category: "config")
    ...
    static func stateDirURL() -> URL {
        genesisPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        genesisPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-genesis-config-file",
            "event": "config.write",
