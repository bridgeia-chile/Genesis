...
function resolveAvatarSource(cfg: genesisConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: genesisConfig, agentId: string): AgentAvatarResolution {
