...
const CLEANUP_STATE_KEY = Symbol.for("genesis.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("genesis.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("genesis.sessionWriteLockWatchdogState");
