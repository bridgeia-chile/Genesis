...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolvegenesisAgentDir() returns mainAgentDir
    process.env.genesis_STATE_DIR = tmpDir;
    process.env.genesis_AGENT_DIR = mainAgentDir;
