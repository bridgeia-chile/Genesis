...
export const DEFAULT_SANDBOX_IMAGE = "genesis-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "genesis-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "genesis-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "genesis-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-21-novnc-auth-default";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "genesis-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "genesis-sandbox-browser";
