...
async function resolveContext(config: genesisConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): genesisConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
