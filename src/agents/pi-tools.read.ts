...
function resolveAdaptiveReadMaxBytes(options?: genesisReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return creategenesisReadTool(base, {
...
export function creategenesisReadTool(
  base: AnyAgentTool,
  options?: genesisReadToolOptions,
): AnyAgentTool {
