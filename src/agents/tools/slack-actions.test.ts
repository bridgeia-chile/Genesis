...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): genesisConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: genesisConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: genesisConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();
