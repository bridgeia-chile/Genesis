...
function resolveMemoryToolContext(options: { config?: genesisConfig; agentSessionKey?: string }) {
...
function resolveMemoryCitationsMode(cfg: genesisConfig): MemoryCitationsMode {
