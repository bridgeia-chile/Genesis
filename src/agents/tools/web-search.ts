...
type WebSearchConfig = NonNullable<genesisConfig["tools"]>["web"] extends infer Web
...
function missingSearchKeyPayload(provider: (typeof SEARCH_PROVIDERS)[number]) {
  ...
  return {
    ...
    message: `web_search needs a Brave Search API key. Run \`${formatCliCommand("genesis configure --section web")}\` to store it, or set BRAVE_API_KEY in the Gateway environment.`,
    docs: "https://docs.genesis.ai/tools/web",
  };
}
