...
function asgenesisConfig(config: Partial<genesisConfig>): genesisConfig {
  return config as genesisConfig;
}
...
function createMemoryGetToolOrThrow(config: genesisConfig = createToolConfig()) {
