...
export const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV =
  "genesis_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "genesis_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "genesis_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable genesis_TELEGRAM_DNS_RESULT_ORDER
