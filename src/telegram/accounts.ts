...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.genesis_DEBUG_TELEGRAM_ACCOUNTS)) {
...
function listConfiguredAccountIds(cfg: genesisConfig): string[] {
...
export function listTelegramAccountIds(cfg: genesisConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: genesisConfig): string {
...
function mergeTelegramAccountConfig(cfg: genesisConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: genesisConfig): ResolvedTelegramAccount[] {
