...
import type { genesisConfig, ReplyToMode, TelegramAccountConfig } from "../config/types.js";
...
async function resolveStickerVisionSupport(cfg: genesisConfig, agentId: string) {
  try {
