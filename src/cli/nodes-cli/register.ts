    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["genesis nodes status", "List known nodes with live status."],
          ["genesis nodes pairing pending", "Show pending node pairing requests."],
          ['genesis nodes run --node <id> --raw "uname -a"', "Run a shell command on a node."],
