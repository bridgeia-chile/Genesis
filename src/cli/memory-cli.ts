    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["genesis memory status", "Show index and provider status."],
          ["genesis memory index --force", "Force a full reindex."],
          ['genesis memory search --query "deployment notes"', "Search indexed memory entries."],
          ["genesis memory status --json", "Output machine-readable JSON."],
