    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["genesis directory self --channel slack", "Show the connected account identity."],
          [
            'genesis directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["genesis directory groups list --channel discord", "List available groups/channels."],
          [
            "genesis directory groups members --channel discord --group-id <id>",
