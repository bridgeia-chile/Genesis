...
${formatHelpExamples([
  ['genesis message send --target +15555550123 --message "Hi"', "Send a text message."],
  [
    'genesis message send --target +15555550123 --message "Hi" --media photo.jpg',
  ...
  [
    'genesis message react --channel discord --target 123 --message-id 456 --emoji "✅"',
    "React to a message.",
  ],
])}
