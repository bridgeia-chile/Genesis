...
${formatHelpExamples([
  ['genesis agent --to +15555550123 --message "status update"', "Start a new session."],
  ['genesis agent --agent ops --message "Summarize logs"', "Use a specific agent."],
  [
  ...
  ['genesis agent --to +15555550123 --message "Summon reply" --deliver', "Deliver reply."],
  [
...
${theme.heading("Examples:")}
${formatHelpExamples([
  ['genesis agents set-identity --agent main --name "genesis" --emoji "🦞"', "Set name + emoji."],
  ["genesis agents set-identity --agent main --avatar avatars/genesis.png", "Set avatar path."],
  [
    "genesis agents set-identity --workspace ~/.genesis/workspace --from-identity",
    "Load from IDENTITY.md.",
  ],
  [
    "genesis agents set-identity --identity-file ~/.genesis/workspace/IDENTITY.md --agent main",
