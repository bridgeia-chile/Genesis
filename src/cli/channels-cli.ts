    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["genesis channels list", "List configured channels and auth profiles."],
          ["genesis channels status --probe", "Run channel status checks and probes."],
          [
            "genesis channels add --channel telegram --token <token>",
