...
function cfg(input: Partial<genesisConfig>): genesisConfig {
  return input as genesisConfig;
}

type ResolveFromConfigInput = Parameters<typeof resolveGatewayCredentialsFromConfig>[0];
type GatewayConfig = NonNullable<genesisConfig["gateway"]>;
...
const DEFAULT_GATEWAY_ENV = {
  genesis_GATEWAY_TOKEN: "env-token",
  genesis_GATEWAY_PASSWORD: "env-password",
