...
import { type genesisConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: genesisConfig): string[] {
...
export function listAgentsForGateway(cfg: genesisConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: genesisConfig): string {
...
function resolveSessionStoreAgentId(cfg: genesisConfig, canonicalKey: string): string {
...
export function getSessionDefaults(cfg: genesisConfig): GatewaySessionsDefaults {
