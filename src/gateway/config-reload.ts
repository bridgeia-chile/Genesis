...
import type { genesisConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function startGatewayConfigReloader(opts: {
  ...
  onRestart: (plan: GatewayReloadPlan, nextConfig: genesisConfig) => void;
  log: {
  ...
  const applySnapshot = async (nextConfig: genesisConfig) => {
