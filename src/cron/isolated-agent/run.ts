...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/bridgeia-chile/Genesis/issues/15692
   */
  delivered?: boolean;
} & CronRunOutcome &
  CronRunTelemetry;
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  // correct per-agent paths (e.g. ~/.genesis/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: genesisConfig = {
    ...params.cfg,
