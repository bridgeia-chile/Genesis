...
function mergeSignalAccountConfig(cfg: genesisConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: genesisConfig): ResolvedSignalAccount[] {
