...
describe("setupOnboardingShellCompletion", () => {
  it("QuickStart: installs without prompting", async () => {
    ...
    expect(deps.ensureCompletionCacheExists).toHaveBeenCalledWith("genesis");
    expect(deps.installCompletion).toHaveBeenCalledWith("zsh", true, "genesis");
