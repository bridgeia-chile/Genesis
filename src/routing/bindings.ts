...
export function listBindings(cfg: genesisConfig): AgentBinding[] {
...
export function listBoundAccountIds(cfg: genesisConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: genesisConfig) {
