...
export function listWhatsAppAuthDirs(cfg: genesisConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: genesisConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: genesisConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: genesisConfig): ResolvedWhatsAppAccount[] {
