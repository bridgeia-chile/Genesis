...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@genesis", { botUsername: "genesis" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@genesis args", {
        botUsername: "genesis",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "genesis" })).toBe(
      "/help@otherbot",
    );
  });
