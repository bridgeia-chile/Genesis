...
function resolveMentionPatterns(cfg: genesisConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: genesisConfig | undefined, agentId?: string): RegExp[] {
