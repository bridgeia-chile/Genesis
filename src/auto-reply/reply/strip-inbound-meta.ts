/**
 * Strips genesis-injected inbound metadata blocks from a user-role message
...
export function stripInboundMetadata(text: string): string {
  ...
  for (let i = 0; i < lines.length; i++) {
    ...
    // Channel untrusted context is appended by genesis as a terminal metadata suffix.
