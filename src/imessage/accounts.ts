...
function mergeIMessageAccountConfig(cfg: genesisConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: genesisConfig): ResolvedIMessageAccount[] {
