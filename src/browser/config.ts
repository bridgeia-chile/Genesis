...
/**
 * Ensure the default "genesis" profile exists in the profiles map.
 ...
 *
 * Note: this is an genesis browser profile (routing config), not a Chrome user profile.
...
function ensureDefaultChromeExtensionProfile(
  ...
  // (legacy single-profile configs may use controlPort+1 for bridgeia-chile/Genesis CDP).
...
export function resolveProfile(
  ...
  let cdpUrl = "";
  const driver = profile.driver === "extension" ? "extension" : "genesis";
