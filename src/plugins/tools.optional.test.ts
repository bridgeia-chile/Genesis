...
const loadgenesisPluginsMock = vi.fn();

vi.mock("./loader.js", () => ({
  loadgenesisPlugins: (params: unknown) => loadgenesisPluginsMock(params),
}));
...
function setRegistry(entries: MockRegistryToolEntry[]) {
  ...
  loadgenesisPluginsMock.mockReturnValue(registry);
  return registry;
}

describe("resolvePluginTools optional tools", () => {
  beforeEach(() => {
    loadgenesisPluginsMock.mockClear();
  });
