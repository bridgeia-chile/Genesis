...
export type genesisPluginConfigSchema = {
...
export type genesisPluginToolContext = {
...
export type genesisPluginToolFactory = (
  ctx: genesisPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type genesisPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type genesisPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<genesisConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type genesisPluginGatewayMethod = {
  method: string;
 ...
 */
export type genesisPluginCommandDefinition = {
...
export type genesisPluginHttpHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean> | boolean;

export type genesisPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<void> | void;

export type genesisPluginCliContext = {
  program: Command;
  config: genesisConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type genesisPluginCliRegistrar = (ctx: genesisPluginCliContext) => void | Promise<void>;

export type genesisPluginServiceContext = {
  config: genesisConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type genesisPluginService = {
  id: string;
  start: (ctx: genesisPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: genesisPluginServiceContext) => void | Promise<void>;
};

export type genesisPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type genesisPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  ...
  register?: (api: genesisPluginApi) => void | Promise<void>;
  activate?: (api: genesisPluginApi) => void | Promise<void>;
};

export type genesisPluginModule =
  | genesisPluginDefinition
  | ((api: genesisPluginApi) => void | Promise<void>);

export type genesisPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | genesisPluginToolFactory,
    opts?: genesisPluginToolOptions,
  ) => void;
  registerHook: (
    events: string | string[],
    handler: InternalHookHandler,
    opts?: genesisPluginHookOptions,
  ) => void;
  registerHttpHandler: (handler: genesisPluginHttpHandler) => void;
  registerHttpRoute: (params: { path: string; handler: genesisPluginHttpRouteHandler }) => void;
  registerChannel: (registration: genesisPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: genesisPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: genesisPluginService) => void;
   ...
   */
  registerCommand: (command: genesisPluginCommandDefinition) => void;
