...
describe("agent components", () => {
  const createCfg = (): genesisConfig => ({}) as genesisConfig;
...
describe("discord component interactions", () => {
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockClear().mockReturnValue("/tmp/genesis-sessions-test.json");
  });
