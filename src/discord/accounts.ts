...
function mergeDiscordAccountConfig(cfg: genesisConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: genesisConfig): ResolvedDiscordAccount[] {
