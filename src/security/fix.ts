...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof genesisConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: genesisConfig; env: NodeJS.ProcessEnv }): {
  cfg: genesisConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
