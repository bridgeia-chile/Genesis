...
describe("QmdMemoryManager", () => {
  ...
  async function createManager(params?: { mode?: "full" | "status"; cfg?: genesisConfig }) {
  ...
  afterEach(async () => {
    ...
    delete (globalThis as Record<string, unknown>).__genesisMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__genesisMcporterColdStartWarned;
  });
