...
export function applyVercelAiGatewayProviderConfig(cfg: genesisConfig): genesisConfig {
...
export function applyVercelAiGatewayConfig(cfg: genesisConfig): genesisConfig {
