...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.genesis.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", genesis_PROFILE: "default" },
    });
...
describe("launchd bootstrap repair", () => {
  it("bootstraps and kickstarts the resolved label", async () => {
    ...
    const label = "ai.genesis.gateway";
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when genesis_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.genesis.gateway.plist",
    },
    {
      name: "uses profile-specific label when genesis_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", genesis_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.genesis.jbphoenix.plist",
    },
    {
      name: "prefers genesis_LAUNCHD_LABEL over genesis_PROFILE",
      env: {
        HOME: "/Users/test",
        genesis_PROFILE: "jbphoenix",
        genesis_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from genesis_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        genesis_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty genesis_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        genesis_PROFILE: "myprofile",
        genesis_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.genesis.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
