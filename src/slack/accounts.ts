...
function mergeSlackAccountConfig(cfg: genesisConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: genesisConfig): ResolvedSlackAccount[] {
