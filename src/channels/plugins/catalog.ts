...
import { discovergenesisPlugins } from "../../plugins/discovery.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, genesisPackageManifest>>;
...
function toChannelMeta(params: {
  channel: NonNullable<genesisPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: genesisPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: genesisPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discovergenesisPlugins({ workspaceDir: options.workspaceDir });
