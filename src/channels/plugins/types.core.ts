...
export type ChannelAgentToolFactory = (params: { cfg?: genesisConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: genesisConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: genesisConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: genesisConfig }) => boolean;
  supportsCards?: (params: { cfg: genesisConfig }) => boolean;
