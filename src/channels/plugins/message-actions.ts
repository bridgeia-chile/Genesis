...
export function listChannelMessageActions(cfg: genesisConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: genesisConfig): boolean {
...
export function supportsChannelMessageCards(cfg: genesisConfig): boolean {
