...
function resolveGatewayPort(cfg: genesisConfig, env: NodeJS.ProcessEnv): number {
...
function resolveAuth(cfg: genesisConfig, env: NodeJS.ProcessEnv): ResolveAuthResult {
  ...
  const password =
    env.genesis_GATEWAY_PASSWORD?.trim() ||
