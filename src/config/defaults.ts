...
function resolveAnthropicDefaultAuthMode(cfg: genesisConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: genesisConfig): genesisConfig {
...
export function applyTalkApiKey(config: genesisConfig): genesisConfig {
...
export function applyModelDefaults(cfg: genesisConfig): genesisConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: genesisConfig): genesisConfig {
...
export function applyLoggingDefaults(cfg: genesisConfig): genesisConfig {
...
export function applyContextPruningDefaults(cfg: genesisConfig): genesisConfig {
...
export function applyCompactionDefaults(cfg: genesisConfig): genesisConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
