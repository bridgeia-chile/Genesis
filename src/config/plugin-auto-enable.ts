...
function isTelegramConfigured(cfg: genesisConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: genesisConfig, env: NodeJS.ProcessEnv): boolean {
...
function isIrcConfigured(cfg: genesisConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: genesisConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: genesisConfig): boolean {
...
function isIMessageConfigured(cfg: genesisConfig): boolean {
...
function isWhatsAppConfigured(cfg: genesisConfig): boolean {
...
function isGenericChannelConfigured(cfg: genesisConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: genesisConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: genesisConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: genesisConfig, pluginId: string): boolean {
...
function isPluginDenied(cfg: genesisConfig, pluginId: string): boolean {
...
function registerPluginEntry(cfg: genesisConfig, pluginId: string): genesisConfig {
  const builtInChannelId = normalizeChatChannelId(pluginId);
  if (builtInChannelId) {
    const channels = cfg.channels as Record<string, unknown> | undefined;
