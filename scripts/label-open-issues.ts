...
const STATE_FILE_PATH = join(CONFIG_BASE_DIR, "genesis", STATE_FILE_NAME);
      ...
      input: [
        {
          role: "system",
          content:
            "You classify GitHub issues and pull requests for genesis. Respond with JSON only, no extra text.",
        },
        {
          role: "user",
          content: [
...
async function main() {
  ...
  logHeader("genesis Issue Label Audit");
