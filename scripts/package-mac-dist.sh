...
# Output:
# - dist/genesis.app
# - dist/genesis-<version>.zip
# - dist/genesis-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.genesis.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/genesis.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/genesis-$VERSION.zip"
DMG="$ROOT_DIR/dist/genesis-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/genesis-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/genesis-$VERSION.dSYM.zip"
