...
- Keep product names in English: genesis, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the genesis Gateway, use “Gateway 网关”.
