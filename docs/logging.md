...
You can override this in `~/.bridgeia-chile/Genesis.json`:
...
All logging configuration lives under `logging` in `~/.bridgeia-chile/Genesis.json`.
...
- `genesis.message.processed`
  - `genesis.channel`, `genesis.outcome`, `genesis.chatId`,
    `genesis.messageId`, `genesis.sessionKey`, `genesis.sessionId`,
    `genesis.reason`
