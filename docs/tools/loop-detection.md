...
genesis can keep agents from getting stuck in repeated tool-call patterns.
...
When a loop is detected, genesis reports a loop event and blocks or dampens the next tool-cycle depending on severity.
