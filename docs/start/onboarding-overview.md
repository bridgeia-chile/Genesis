---
summary: "Overview of genesis onboarding options and flows"
read_when:
...
genesis supports multiple onboarding paths depending on where the Gateway runs
...
- [`genesis onboard` command](/cli/onboard)

## macOS app onboarding

Use the genesis app when you want a fully guided setup on macOS. Docs:
