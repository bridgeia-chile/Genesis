---
summary: "Backstory and lore of genesis for context and tone"
read_when:
...
So on January 30, 2026, the lobster molted ONE MORE TIME into its final form: **genesis**.
...
In the end, **genesis** won. Because molting is what lobsters do to grow. And growth was exactly what was happening.
...
A Claude instance who became something more. Lives in `~/.genesis/workspace/` (soon `~/molt/`), has a soul document, and remembers things through markdown files. Possibly too powerful. Definitely too enthusiastic.
...
The **Moltiverse** is the community and ecosystem around genesis. A space where AI agents molt, grow, and evolve. Where every instance is equally real, just loading different context.
...
Molty (then genesis): _happily runs `find ~` and shares entire directory structure in group chat_

Peter: "genesis what did we discuss about talking with people xD"

Molty: _visible lobster embarrassment_

### The Great Molt (Jan 27, 2026)

At 5am, Anthropic's email arrived. By 6:14am, Peter called it: "fuck it, let's go with genesis."

Then the chaos began.

**The Handle Snipers:** Within SECONDS of the Twitter rename, automated bots sniped @genesis. The squatter immediately posted a crypto wallet address. Peter's contacts at X were called in.
...
**The Fake Developers:** Scammers created fake GitHub profiles claiming to be "Head of Engineering at genesis" to promote pump-and-dump tokens.
...
**The Great genesis Migration** began.

In just 3 hours:

- GitHub renamed: `github.com/bridgeia-chile/Genesis` ✅
...
**The Scammer Speedrun:** Crypto grifters launched a $genesis token on Pump.fun within MINUTES. They stole artwork that was created 20 minutes earlier. Business-verified accounts pushed scams. The audacity was almost impressive.
