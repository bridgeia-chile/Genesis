---
summary: "First-run onboarding flow for genesis (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give genesis">
...
<Step title="CLI">
  ...
  The app can install the global `genesis` CLI via npm/pnpm so terminal
