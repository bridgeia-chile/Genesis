...
genesis treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.genesis/settings/voicewake.json`

Shape:

```json
{ "triggers": ["genesis", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
