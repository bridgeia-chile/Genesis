...
- 生成的 Swift 模型：`apps/macos/Sources/genesisProtocol/GatewayModels.swift`
...
- https://raw.githubusercontent.com/bridgeia-chile/Genesis/main/dist/protocol.schema.json
