...
本指南总结了在 genesis 中开发 Pi 集成的合理工作流程。
...
状态存储在 genesis 状态目录下。默认为 `~/.genesis`。如果设置了 `genesis_STATE_DIR`，则使用该目录。
...
- https://docs.genesis.ai/testing
- https://docs.genesis.ai/start/getting-started
