---
summary: "Use Qwen OAuth (free tier) in genesis"
read_when:
  - You want to use Qwen with genesis
...
If you already logged in with the Qwen Code CLI, genesis will sync credentials
