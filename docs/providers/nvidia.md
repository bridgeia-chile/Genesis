---
summary: "Use NVIDIA's OpenAI-compatible API in genesis"
read_when:
  - You want to use NVIDIA models in genesis
...
genesis models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
