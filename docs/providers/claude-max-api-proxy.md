...
You can point genesis at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or genesis
...
- [Anthropic provider](/providers/anthropic) - Native genesis integration with Claude setup-token or API keys
