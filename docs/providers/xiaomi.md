---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with genesis"
read_when:
  - You want Xiaomi MiMo models in genesis
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). genesis uses
