---
summary: "Use Qianfan's unified API to access many models in genesis"
read_when:
...
3. genesis installed on your system
...
4. Copy the API key for use with genesis

## CLI setup

```bash
genesis onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [genesis Configuration](/gateway/configuration)
