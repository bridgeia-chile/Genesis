...
Deploy genesis on Northflank with a one-click template and finish setup in your browser.
...
8. Open the public genesis URL and complete setup at `/setup`.
9. Open the Control UI at `/genesis`.
...
4. Click **Run setup**.
5. Open the Control UI at `https://<your-northflank-domain>/genesis`
