...
genesis ships three update channels:
...
When you **explicitly** switch channels with `--channel`, genesis also aligns
the install method:
...
When you switch channels with `genesis update`, genesis also syncs plugin sources:
