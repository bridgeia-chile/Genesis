...
- Same path: run the app from a fixed location (for genesis, `dist/genesis.app`).
...
Workaround: move files into the genesis workspace (`~/.genesis/workspace`) if you want to avoid per-folder grants.
