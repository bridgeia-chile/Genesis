...
read_when:
  - You want Zalo Personal (unofficial) support in genesis
...
Zalo Personal support for genesis via a plugin, using `zca-cli` to automate a normal Zalo user account.
...
```bash
genesis plugins install ./extensions/zalouser
