...
read_when:
  - You are building a genesis plugin
...
Every plugin **must** ship a `genesis.plugin.json` file in the **plugin root**.
genesis uses this manifest to validate configuration **without executing plugin
