...
- Or from a source checkout: `genesis plugins install ./extensions/zalouser`
...
- On startup, genesis resolves group/user names in allowlists to IDs and logs the mapping; unresolved entries are kept as typed.
