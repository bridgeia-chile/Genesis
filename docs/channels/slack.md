...
```
  ...
  <Tab title="HTTP Events API mode">
    <Steps>
      ...
      <Step title="Configure genesis HTTP mode">
...
<Tabs>
  <Tab title="DM policy">
    ...
    Pairing in DMs uses `genesis pairing approve slack <code>`.
...
genesis supports Slack native text streaming via the Agents and AI Apps API.
...
- If streaming fails mid-reply, genesis falls back to normal delivery for remaining payloads.
