...
summary: Machine-checked security models for genesis’s highest-risk paths.
read_when:
...
This page tracks genesis’s **formal security models** (TLA+/TLC today; more as needed).

> Note: some older links may refer to the previous project name.

**Goal (north star):** provide a machine-checked argument that genesis enforces its
...
**What this is not (yet):** a proof that “genesis is secure in all respects” or that the full TypeScript implementation is correct.

## Where the models live

Models are maintained in a separate repo: [vignesh07/genesis-formal-models](https://github.com/vignesh07/genesis-formal-models).
...
```bash
git clone https://github.com/vignesh07/genesis-formal-models
cd genesis-formal-models
